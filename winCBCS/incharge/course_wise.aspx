<%@ Page Title="" Language="C#" MasterPageFile="~/incharge/incharge.Master" AutoEventWireup="true" CodeBehind="course_wise.aspx.cs" Inherits="winCBCS.incharge.WebForm10" %>
                ...
                <div class="form-horizontal ">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <asp:DropDownList ID="drpsem" runat="server" CssClass="form-control" Enabled="true" OnSelectedIndexChanged="drpsem_SelectedIndexChanged1" AutoPostBack="True">
                                <asp:ListItem Value="0">--Select--</asp:ListItem>
                            ...
                            <label for="email">Academic Course :</label>
                            <asp:DropDownList ID="DropDownList1" runat="server" CssClass="form-control" Enabled="true" >
                                <asp:ListItem Value="0">--Select--</asp:ListItem>
