...
namespace winCBCS.incharge
{
    public partial class WebForm1 : System.Web.UI.Page
    {
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            MySqlCommand cmd = new MySqlCommand("insert into timetable_course (course_name, course_academic_year, course_academic_sem) values(?course_name, ?course_academic_year, ?course_academic_sem)",con);
