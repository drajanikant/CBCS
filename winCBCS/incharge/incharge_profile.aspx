  ...
  <div class="panel-body">
       ...
       <div class="form-horizontal ">
            ...
            <div class="form-group">
              <asp:Label ID="Label3" runat="server" CssClass="col-md-4 control-label" Text="Employee ID">

              </asp:Label>
             <div class="col-md-6">
                 <asp:TextBox ID="txtEmpid" CssClass="col-md-2 form-control" runat="server"></asp:TextBox>
                 <asp:RequiredFieldValidator ID="RequiredFieldValidator2" CssClass="text-danger" runat="server" ErrorMessage="Enter Confirm Password !!!" ControlToValidate="txtEmpid"></asp:RequiredFieldValidator>
             </div>
             </div>
           ...
           <div class="form-group">
             ...
             <div class="col-md-6">
                 <asp:TextBox ID="txtName" CssClass="col-md-2 form-control" runat="server"></asp:TextBox>
